# Generated by Django 3.1.3 on 2021-01-16 12:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player_1_id_type', models.CharField(choices=[('battle', 'Battlenet ID'), ('psnet', 'PSNET ID'), ('acti', 'Activision ID')], default='battle', max_length=10)),
                ('player_2', models.CharField(blank=True, max_length=100, null=True)),
                ('player_2_id_type', models.CharField(choices=[('battle', 'Battlenet ID'), ('psnet', 'PSNET ID'), ('acti', 'Activision ID')], default='battle', max_length=10)),
                ('player_3', models.CharField(blank=True, max_length=100, null=True)),
                ('player_3_id_type', models.CharField(choices=[('battle', 'Battlenet ID'), ('psnet', 'PSNET ID'), ('acti', 'Activision ID')], default='battle', max_length=10)),
                ('player_4', models.CharField(blank=True, max_length=100, null=True)),
                ('player_4_id_type', models.CharField(choices=[('battle', 'Battlenet ID'), ('psnet', 'PSNET ID'), ('acti', 'Activision ID')], default='battle', max_length=10)),
